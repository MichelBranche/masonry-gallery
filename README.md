...
Layout tipo Pinterest realizzato con **HTML + CSS**, con griglia masonry, overlay interattivi e micro-interazioni.  
...
## 🧰 Tech Stack
- HTML5
- CSS3 (columns masonry, hover/overlay, responsive)
